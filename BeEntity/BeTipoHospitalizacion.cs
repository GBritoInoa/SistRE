...
{
    /// <summary>
    /// Class BeTipoHospitalizacion
    /// </summary>
    public class BeTipoHospitalizacion
    {

        [DisplayName("Tipo Hospitalizacion")]
        public int TipoHospitalizacionID { get; set; }
        [DisplayName("Hospitalizacion")]
