...
{
    /// <summary>
    /// Class BeTipoFallecimiento
    /// </summary>
    public class BeTipoFallecimiento
    {

        [DisplayName("Tipo Fallecimiento")]
        public int TipoFallecimientoID { get; set; }
        [DisplayName("Fallecimiento")]
