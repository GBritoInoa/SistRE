...
{
    /// <summary>
    /// Class BeProtestaConvocatoria
    /// </summary>
    public class BeProtestaConvocatoria : BeUserLogueado
    {

        [DisplayName("Tipo Protesta Convocatoria")]
        public int ProtestaConvocatoriaID { get; set; }
        [DisplayName("Protesta Convocatoria")]
